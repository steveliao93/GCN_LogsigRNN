...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--part1-path', default='../data/nturgbd_raw/nturgb+d_skeletons/')
    parser.add_argument(
        '--part2-path', default='../data/nturgbd_raw/nturgb+d_skeletons120/')
    ...
    for b in benchmark:
        for p in part:
            ...
            print(b, p)
            gendata(file_list, out_path,
                    arg.ignored_sample_path, benchmark=b, part=p)
